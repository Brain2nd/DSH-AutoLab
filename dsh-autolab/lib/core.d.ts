import { $ as RoleState, A as listCommittedManifestHashes, B as sha256, C as DraftSnapshot, Ct as rolePhaseSchema, D as durableWriteFile, Dt as validateLabId, E as RevisionValidation, Et as transitionRuntimeState, F as hashResolvedManifest, G as CONTROL_PAYLOAD_HASH_PATTERN, H as ActiveReview, I as parseResolvedManifest, J as LAB_ID_PATTERN, K as ConfigRef, L as resolvedManifestSchema, M as ManifestValidationError, N as ResolvedManifest, O as generateLabId, P as RoleBinding, Q as ReviewResolutionState, R as roleBindingSchema, S as ArtifactStore, St as roleActivationBlockerSchema, T as LabScaffold, Tt as runtimeStateSchema, U as ActiveTrial, V as ActiveCandidate, W as AutoLabStateError, X as ReviewResolutionBody, Y as LabLifecycle, Z as ReviewResolutionError, _ as hashRolePacket, _t as reviewPauseStateSchema, a as PreflightVerdict, at as adoptRuntimeOwner, b as verbatimBlockSchema, bt as reviewResultStateSchema, c as freezePreflightVerdictArtifact, ct as controllerGoalSchema, d as CompileRolePacketInput, dt as labLifecycleSchema, et as RuntimeState, f as CompiledRolePacket, ft as parseState, g as compileRolePacket, gt as reviewFreezeComplete, h as VerbatimBlock, ht as reviewCapabilityStateSchema, i as PreflightTopLevelVerdict, it as activeTrialSchema, j as readRevisionAtPath, k as isCommittedManifestHash, l as parsePreflightVerdict, lt as createRuntimeState, m as RolePacket, mt as resolutionHash, n as FrozenPreflightVerdict, nt as activeCandidateSchema, o as PreflightVerdictError, ot as autolabDomainSpec, p as PacketValidationError, pt as recordReviewResolution, q as ControllerGoalState, r as PreflightBlockingFinding, rt as activeReviewSchema, s as freezePreflightVerdict, st as configRefSchema, t as FreezePreflightVerdictInput, tt as SHA256_PATTERN, u as parsePreflightVerdictArtifact, ut as goalInstallSchema, v as parseRolePacket, vt as reviewReadyToAdvance, w as FrozenRevision, wt as roleStateSchema, x as ArtifactError, xt as reviewVerdictStateSchema, y as rolePacketSchema, yt as reviewResolutionStateSchema, z as canonicalJson } from "./preflight-verdict-CXTEcGGj.js";
import { z } from "zod";
